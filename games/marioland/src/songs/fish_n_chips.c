...
static const hUGENoiseInstr_t noise_instruments[] = {
    ...
    {241,itNoiseSP3,104,0,0},
    {145,itNoiseSP4,119,0,0},
    {242,itNoiseSP5,41,0,0},
    {240,itNoiseSP6,0,0,0},
    {240,itNoiseSP7,40,0,0},
...
const hUGESong_t fish_n_chips = {7, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
