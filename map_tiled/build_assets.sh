...
node ../../tiled-gameboy-tool/build/index.js --output-dir src/maps --tiled assets/World1Area1.tmx --bank AUTOBANKED -export-solid-map
sed -i '1d' src/maps/world1area1.c
node ../../tiled-gameboy-tool/build/index.js --output-dir src/maps --tiled assets/World1Area2.tmx --bank AUTOBANKED -export-solid-map
